...
export const siteConfig: SiteConfig = {
	title: "บอร์ดแล้วบ่น | Tiny Meeple Talk",
	subtitle: "collection of board game reviews and thoughts",
...
export const profileConfig: ProfileConfig = {
	...
	name: "Sisada R.",
	bio: "Board Game Nerd, Cat Lover, Tech Enthusiast.",
	links: [
		{
			name: "Facebook",
